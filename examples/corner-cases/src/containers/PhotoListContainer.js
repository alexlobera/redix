...
class PhotoListContainer extends Container {
  ...
  constructor(props) {
      ...
      // We are setting the propTypes here because PhotoList is not specifying its propTypes
      // Redix container uses the propTypes to automatically pass the props to the presentational container (PhotoList in this case)
      this.setComponent(PhotoList, {
        mapPropFuncsToThis: props,
        disablePropsChildren: true,
        propTypes: {
